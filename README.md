...
Encrypted Message : dudylqgkqdwk

Decrypted Message: aravindhnath
...
Plain text: aravindhnath

Cipher text: tovegofbossf

Decrypted text: aravindhnath
...
Input message : aravindhnath

Padded message : ARAVINDHNATH

Encoded message : IZILOYRBEATT

Decoded message : ARAVINDHNATH
## RESULT:
...
int main() {
    ...
    char message[] = "ARAVINDHNATH"; // Replace with your message
    printf("Plain text:%s\n",message);
    printf("Key text:%s\n",key);
    // Encrypt the message
...
Encrypted Message: SRVZMGKHFAOL
...
Enter a Secret Message: aravindhnath

Enter number of rails:3

Encrypted message:ainrvnhahadt
